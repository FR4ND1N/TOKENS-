...
int main() {
    ...
    printf("\t\t\t\t\t================= Evolucao  ===================\n");
    printf("\t\t\t\t\t=====================Da========================\n");
    printf("\t\t\t\t\t=========== Tecnologia Comtemporanea =============\n");
    printf("\t\t\t\t\t===============================================\n");
    printf("\t\t\t\t\t===============================================\n\n");

    // Abre o arquivo para escrita
    FILE *arquivoCSV = fopen("relatorio_evolucaotecnologia.csv", "w");
    ...
    printf("\nRelatorio de vendas do dia gravado em 'relatorio_evolucaotecnologia.csv'.\n");
